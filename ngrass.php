      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            <h1>Natural Grass</h1>
            <p>We are offering Natural Lawn Grass Carpet.<br>
            Playground Grass.</p>
    ...
    <div class="row">
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <h2> Natural <span>Grass & Carpet</span></h2>
          <hr>
          <p>We are offering Natural Lawn Grass Carpet to our clients. We are a leading supplier of Natural grass carpet, lawn grass carpet, garden grass, Mexican grass carpet, playground grass, and stadium grass. We offer several types of Natural grass to suit different types of customers and garden requirements, there is a wide variety of grasses available with us, ready to deliver and install as per requirements like Korean grass, selection number one grass, Bermuda grass, Mexican grass and different types of other Natural lawn grass for landscaping and horticulture development.</p>
          
        </div>
      </div>
      <div class="col-xs-12 col-md-6">
        <div class="about-media">
          <img src="img/tipsforhealth.webp" alt="Healthy and Stress-Free Tips">
