      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            <h1>Pain Relief <br> Pills</h1>
            <div class="col-md-0 hover-bg">
            <img src="img/vcd.png" class="img-responsive" alt="medicine" style="display: block; margin-left: auto; margin-right: auto;">
          </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-md-6">
        ...
        <h2> Want <span>To Be Pain-Free?</span></h2>
        <hr>
      ...
      <div class="col-xs-12 col-md-6">
        <div class="about-media">
          <img src="img/vcdin.png" alt="Pain Management Tips">
...
<div id="portfolio">
  <div class="container">
    <div class="section-title text-center center">
      <h2>Stay Healthy and Painless</h2>
      <hr>
      ...
      <div class="col-sm-12">
        <div class="portfolio-item d-flex">
          <div class="col-md-6 hover-bg">
            <img src="img/tipsforhealth2.jpg" class="img-responsive" alt="tips" style="display: block; margin-left: auto; margin-right: auto; margin-bottom: 30px">
          </div>
